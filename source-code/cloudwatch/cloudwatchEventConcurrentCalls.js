...
const cloudwatchEventConcurrentCalls = {
    ...
    const indexName = constants.concurrentCallIndex + todayDate;
...
module.exports = cloudwatchEventConcurrentCalls;
